...
Write them for the agents that read them next and the human who approves them. Say each thing once, where it belongs. Keep every fact and every why; cut what another line already says. Fragments are fine when nothing is lost.
