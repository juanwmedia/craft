...
- **one-step close**: /close's last offer: merge into the branch the tree was cut from, remove the worktree and its branch, return the session there. _Avoid_: auto-merge, finish.
